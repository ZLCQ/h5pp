...
function(fmt_check_version_include incdir)
    ...
    elseif(IS_DIRECTORY "${${incdir}}")
     ...
     # Starting from fmt 11 we find the FMT_VERSION macro in base.h (which didn't exist prior)
    if(EXISTS ${include}/fmt/base.h)
        set(_fmt_version_file "${include}/fmt/base.h")
    elseif(EXISTS ${include}/fmt/bundled/core.h)
        set(_fmt_version_file "${include}/fmt/bundled/base.h")
    elseif(EXISTS ${include}/fmt/core.h)
